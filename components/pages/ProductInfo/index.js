		...
		return (
			<>
				<View style={styles.descriptionContainer}>
					...
					<OurText
						style={styles.description}>{data?.product?.description || t("productNoDescription")}</OurText>
				</View>
				<View style={styles.attributeContainer}>
					{
						data?.product?.variations ?
							<OurVariationPicker productName={name} productId={id}
												data={data?.product?.variations?.nodes}
												model={[variation, setVariation]}/>
							:
							<></>
					}
				</View>

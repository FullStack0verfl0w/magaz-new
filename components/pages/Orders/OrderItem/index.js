	...
	return (
		<View style={styles.mainContainer}>
			<TouchableOpacity onPress={() => navigation.navigate("OrderInfo", {
				id: data.data.databaseId,
				status: data.status.order_status
			})}>
				<View style={styles.orderInfoContainer}>
					<View style={styles.orderMainInfo}>
						<View style={styles.infoContainer}>
							<OurText style={styles.textField} translate={true}
									 params={{ id: data.data.databaseId }}>orderNumber</OurText>
						</View>
						<View style={styles.infoContainer}>
							<OurText style={styles.textField} translate={true}
									 params={{ total: data.data.total }}>cartTotal</OurText>
						</View>
					</View>
					<View style={styles.orderStatusContainer}>
						<OurText style={styles.textField} translate={true}>orderStatus</OurText>
						<OurText style={styles.orderStatus}
								 translate={true}>{`orderStatus_${data.status.order_status}`}</OurText>
					</View>
				</View>
